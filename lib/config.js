...
var sendTraceObject = require('./trace-object');
var sendMetrics = require('./metrics');
var sendTraces = require('./traces');
...
if (cluster.isWorker) {
  module.exports = {
    ...
    sendTraceObject: sendTraceObject,
...
config.start = function start() {
  ...
  this.sendTraceObject(runctl.parentCtl);
  this.sendTraces(runctl.parentCtl);
